    ...
    while not quitevent.is_set():
        try:
            ...
            resp, content = h.request(
                "http://perf-hier.appspot.com/api/register_event?bt=Firefox-3.6:Linux&ph_id=205001&data={%22name%22:%22whole%22,%22childrens%22:[{%22name%22:%22page%22,%22childrens%22:[{%22name%22:%22body%22,%22childrens%22:[],%22val%22:411}],%22val%22:415}],%22val%22:415}&")
            if resp.status != 204:
                print "Response not OK", resp.status
            # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
